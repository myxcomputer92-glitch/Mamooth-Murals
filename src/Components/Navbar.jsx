  ...
  return (
    <div className='w-full h-[12vh] bg-[#FFD900]'>
      <nav className='p-8 flex justify-between'>
        <h1 className='text-xl bg-black text-white h-[5vh] pt-1 w-[14vw] text-center uppercase font-first border-2 border-transparent rounded-sm cursor-pointer'>Mamooth Murals</h1>
